            ...
            <div class="xs:grid-cols-2 grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                @foreach ($movies as $movie)
                    <div
                        ...
                        <button data-modal-target="popup-modal {{ $movie->id }}"
                            data-modal-toggle="popup-modal {{ $movie->id }}" class="absolute right-0 p-2"
                            type="button">
                            <svg class="h-6 w-6 text-red-700 hover:text-red-800 dark:text-white" aria-hidden="true"
                                ...
                                <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 text-center md:p-5">
                                        ...
                                        <div class="flex justify-center">
                                            {{--
                                                <button data-modal-hide="popup-modal {{ $movie->id}}" type="button"
